window.onload = () => {
    ...
    let songs = [
      {
        title: "DIVINE",
        artist: "Girls Generartion",
        song_path: "/assets/music/DIVINE.mp3",
        img_path: "/assets/img/divine.jpg",
      },
      {
        title: "COMPLETE",
        artist: "Girls Generartion",
        song_path: "/assets/music/COMPLETE.mp3",
        img_path: "/assets/img/complete.jpg",
      },
      {
        title: "FOREVER",
        artist: "Girls Generartion",
        song_path: "/assets/music/FOREVER.mp3",
        img_path: "/assets/img/forever.jpg",
      },
      {
        title: "ONE LAST TIME",
        artist: "Girls Generartion",
        song_path: "/assets/music/ONELASTTIME.mp3",
        img_path: "/assets/img/onelasttime.jpg",
      },
    ];
